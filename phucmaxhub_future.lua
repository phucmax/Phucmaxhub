...
-- Giao diện tương lai bởi ChatGPT
local ScreenGui = Instance.new("ScreenGui", game:GetService("Players").LocalPlayer:WaitForChild("PlayerGui"))
ScreenGui.Name = "PhucMaxFutureUI"
...
Title.Text = "PHUCMAX HUB - Giao Diện Tương Lai"
...
Button.Text = "Chạy Script Fix Lag"
...
Button.MouseButton1Click:Connect(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/phuccodelo2/Phucfixlaglo/main/phucfixlag.lua"))()
end)
